...
В этом пресете будут прекрасно работать `style-components`.
...
`styed-components` мной забанены до тех пор,
пока там не появится возможность управлять конечным именем классов.
Может быть там это и можно делать, но у я пока не научился.
